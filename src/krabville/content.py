...
PATH_NODES = {
    "square": (866, 372),
    "square-west": (751, 372),
    "square-east": (1074, 372),
    "square-south": (878, 450),
    "cafe-junction": (693, 372),
    "cafe": (653, 381),
    "post-office": (976, 377),
    "west-bridge": (497, 364),
    "radio": (75, 173),
    "west-north": (404, 260),
    "observatory": (670, 277),
    "northwest-loop": (520, 173),
    "willow": (670, 208),
    "north-center": (924, 234),
    "maple": (924, 165),
    "north-east": (1213, 225),
    "lantern": (1294, 165),
    "clinic": (1109, 286),
    "greenhouse-junction": (1559, 260),
    "glass": (1698, 264),
    "east-north": (1559, 212),
    "post-house": (1444, 199),
    "east-bridge": (1433, 364),
    "birch": (1352, 338),
    "workshop-junction": (1421, 450),
    "workshop": (1132, 468),
    "lower-west": (693, 450),
    "rose-junction": (578, 528),
    "rose": (578, 528),
    "gear": (335, 381),
    "dock-junction": (866, 606),
    "harbour": (809, 658),
    "lower-east": (1213, 468),
    "garden-path": (1456, 476),
    "pine": (1571, 546),
    "shore-path": (1559, 624),
    "lotus": (1444, 650),
    "seagrass": (364, 61),
    "harbourview": (1190, 368),
    "tideglass": (1594, 212),
    "cedar-quays": (1433, 576),
    "boardwalk-row": (1536, 585),
    "spruce-court": (1328, 641),
    "heron-house": (462, 191),
    "lighthouse-row": (1328, 121),
    "daycare": (416, 95),
    "tide-market": (1005, 372),
    "bakery": (1409, 580),
    "restaurant": (1363, 580),
    "cinema": (901, 468),
    "theatre": (1005, 476),
...
PATH_EDGES = (
    ...
    ("northwest-loop", "heron-house"),
    ("heron-house", "daycare"),
    ("daycare", "seagrass"),
    ("seagrass", "northwest-loop"),
    ("north-east", "lighthouse-row"),
    ("lighthouse-row", "post-house"),
    ("east-north", "tideglass"),
    ("tideglass", "greenhouse-junction"),
    ("square-east", "tide-market"),
    ("square-east", "harbourview"),
    ("harbourview", "east-bridge"),
    ("square-south", "cinema"),
    ("cinema", "theatre"),
    ("theatre", "workshop"),
    ("workshop", "hardware"),
    ("garden-path", "restaurant"),
    ("restaurant", "bakery"),
    ("bakery", "cedar-quays"),
    ("cedar-quays", "boardwalk-row"),
    ("cedar-quays", "spruce-court"),
    ("spruce-court", "shore-path"),
    ("gear", "arcade"),
    ("arcade", "rose-junction"),
    ("harbour", "electronics"),
    ("electronics", "dock-junction"),
    ("lotus", "laundromat"),
    ("laundromat", "gym"),
    ("gym", "shore-path"),
)
...
LOCATION_ACCESS = {
    ...
    "Willow Market": "cafe",
    "Seagrass Apartments": "seagrass",
    "Harbourview Co-op": "harbourview",
    "Tideglass Towers": "tideglass",
    "Cedar Quays Apartments": "cedar-quays",
    "Boardwalk Row": "boardwalk-row",
    "Spruce Court": "spruce-court",
    "Heron House": "heron-house",
    "Lighthouse Row": "lighthouse-row",
    "Canal Childcare": "daycare",
    "Tide Market": "tide-market",
    "Lagoon Bakery": "bakery",
    "Boardwalk Restaurant": "restaurant",
    "Lagoon Cinema": "cinema",
    "Tide Theatre": "theatre",
    "Krabville Gym": "gym",
    "Shoreline Arcade": "arcade",
    "Northstar Electronics": "electronics",
    "Harbour Hardware": "hardware",
    "Seagrass Laundry": "laundromat",
}
